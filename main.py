...
parser.add_argument(
    '--resume',
    type=str,
    default='./pretrained_model/vgg_16_bn.pt',
...
parser.add_argument(
    '--job_dir',    #在测试.py里面它叫做--test_model_dir
    type=str,
...
parser.add_argument(
    '--epochs',
    type=int,
    default=1, # 1 for debug , 15 for fineturn
...
criterion = nn.CrossEntropyLoss()    #sun
